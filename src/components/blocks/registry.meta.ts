    ...
    editor: {
      config: [
        { key: 'display', label: 'Layout', type: 'layout', default: 'explorer', options: [
          ...
          { value: 'opportunities', label: 'Opportunities finder', shape: 'faculty-finder' },
        ] },
        ...
        { key: 'programIds', label: 'Study programs to show', type: 'entitymulti', entity: 'study_programs',
          ...
          showFor: { field: 'display', equals: ['explorer', 'opportunities'] } },
        { key: 'areas', label: 'Areas to show', type: 'multiselect',
          options: PROGRAM_AREAS.map((a) => ({ value: a.value, label: a.en })),
          help: 'Sections shown under each study program. For the Opportunities finder, pick the tracks audiences search for (e.g. Study Abroad, International Internship).',
          showFor: { field: 'display', equals: ['explorer', 'opportunities'] } },
        ...UNIVERSAL,
      ],
      content: [
